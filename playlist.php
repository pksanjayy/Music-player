...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Spotify Player | mp3 audio music player </title>
    <link rel="stylesheet"
...
<tr>
  <td>
    <div class="heading">
    <h1 style="margin-bottom: 0;font-family: 'Montserrat', sans-serif;">Discover weekly</h1>
...
$(document).ready(function () {
	...
	function load() {
		...
		function createArray(maxValue) {
		  ...
		  function getRandomImages() {
			...
			return [shuffledBeatpack.slice(0, 20), shuffledSongs.slice(0, 20), shuffledArtists.slice(0, 20),shuffledindexes];
		  }
  ...
  randomBeatpack.splice(20, 1);
  randomSongs.splice(20, 1);
  randomArtists.splice(20, 1);
  shuffledindexes.splice(20, 1); 
  ...
  $(".heart").on("click", function() {
    ...
    $.ajax({
      url: "add_row.php", // Update the URL here
      method: "POST",
      data: {
        id: id,
        name:name,
